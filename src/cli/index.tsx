...
program.command("chat")
  ...
  .option("--plain", "Use the simple readline shell instead of the animated Ink TUI. Recommended if a Windows IME candidate window is misplaced.")
  .option("--ink", "Use the animated Ink TUI. This is the default for interactive terminals.")
