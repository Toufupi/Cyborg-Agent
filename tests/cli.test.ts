...
describe("cli", () => {
  ...
  it("documents the IME-safe chat fallback and optional Ink UI", async () => {
    ...
    expect(result.stdout).toContain("candidate window");
    expect(result.stdout).toContain("animated Ink TUI");
  });
